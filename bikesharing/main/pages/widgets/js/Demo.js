...
new jBox('Tooltip', {
  ...
  onClose: function() {
    this.source.removeClass('active').html('建议');
  }
});
...
$('#Notice-1').click(function() {
  ...
  new jBox('Notice', {
    content: '建议开放区域：1区、5区、6区、11区、16区、19区、20区、21区、22区、23区',
    color: 'black'
  });
...
$('#Notice-2').click(function() {
  ...
  new jBox('Notice', {
    animation: 'flip',
    color: getColor(),
    content: '开放区域：1区、5区、6区、11区、16区、19区、20区、21区、22区、23区 '
  });
...
$('#Notice-4').click(function() {
  ...
  new jBox('Notice', {
    ...
    color: getColor(),
    title: '停放点开闭方案',
    content: '建议开放区域：1区、5区、6区、11区、16区、19区、20区、21区、22区、23区\ 建议关闭区域：2区、3区、4区、7区、8区、9区、10区、12区、13区、14区、15区、17区、18区'
  });
...
$('.target-notice').click(function() {
  $(this).addClass('active').html('建议开放区域');
}).mouseleave(function() {
  $(this).removeClass('active').html('建议开放区域');
});
